...
public class VisionConstants {
  ...
  public static final class pvConstants {
    ...
    public static final Transform2d SHOOTER_OFFSET =
        new Transform2d(-Units.inchesToMeters(10), 0, Rotation2d.kZero);

    public static final Transform3d ROBOT_TO_QUEST =
        new Transform3d(-0.26545065, 0.18207046, 0, new Rotation3d(0, 0, Math.PI / 2));

    public static final Transform3d ROBOT_TO_SNIPER =
        new Transform3d(
            -Units.inchesToMeters(5),
            -Units.inchesToMeters(1.375),
            Units.inchesToMeters(19),
            new Rotation3d(0, Units.degreesToRadians(-56), 0));

    public static final Transform3d ROBOT_TO_NOM =
        new Transform3d(
            -Units.inchesToMeters(5),
            -Units.inchesToMeters(1.375),
            Units.inchesToMeters(19),
    ...
    public static Matrix<N3, N1> QNAV_STD_DEVS =
        VecBuilder.fill(
    ...
    /**
     * The threshold for the error between the best AprilTag pose estimate and the QuestNav pose
     * measurements for the QuestNav pose to be considered valid
     */
